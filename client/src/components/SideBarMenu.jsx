  ...
  return (
    ...
    <div
      className={`col-span-2 xl:block ${
        isOpen ? "block" : "hidden"
      } fixed z-10 inset-0  xl:relative xl:z-auto max-w-fit  min-h-screen h-full xl:shadow-lg top-0 bg-white `}
    >
      <div className=" xl:h-screen w-full border-r border-border flex flex-col px-2 ">
        <Link>
          <img
            src="/images/logo.png"
            alt="logo"
        ...
        <div className="mt-12 flex-grow w-full text">
          {/* <Link
            to="/home"
          ...
          {links.map((link, index) => (
            <Link
              ...
              key={index}
              // className={`${
              //   isActive(link.route) ? "bg-main text-white" : "text-subMain"
              // } flex items-center gap-4 font-medium text-sm transitions hover:bg-main hover:text-white rounded-lg w-full px-6 py-4`}
              className={`mt-2 flex gap-4 transitions group text-white items-center w-full py-4 px-5 rounded-lg hover:bg-[#f2faf8ff] ${
          ...
          {/* <Link
            to="/patients"
            className={`flex gap-4 transitions group items-center w-full py-4 px-5 rounded-lg hover:bg-[#f2faf8ff] ${
              isActive("/patients") ? "bg-[#f2faf8ff]" : ""
            }`}
          >
            <svg
              stroke="#65b5a2ff"
